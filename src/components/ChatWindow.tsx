        ...
        <div className="mx-auto w-full max-w-3xl space-y-6">
                ...
                <div className={`max-w-[85%] ${message.role === 'user' ? 'order-first' : ''}`}>
                  {message.role === 'user' ? (
                    ...
                    <div className="space-y-2">
                      <div className="rounded-2xl rounded-bl-md border border-gray-700 bg-[#1E293B] px-4 py-3 text-gray-100 shadow-sm">
                        <p className="whitespace-pre-wrap text-sm">{message.content}</p>
                      </div>
                      <div className="flex gap-2 pr-2">
                        <button
                          onClick={() => onCopy(message.content)}
                          className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-gray-500 transition hover:bg-gray-800"
                        >
                          <Copy size={13} />
                          نسخ
                        </button>
          ...
          {isGenerating && (
            <div className="flex justify-start">
              ...
              <div className="rounded-2xl rounded-bl-md border border-gray-700 bg-[#1E293B] px-4 py-3">
